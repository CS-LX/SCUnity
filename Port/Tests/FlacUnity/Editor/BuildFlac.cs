    ...
    public static class BuildFlac
    {
        ...
        public static void Build()
        {
            try
            {
                ...
                PlayerSettings.productName = "SCUnity FLAC Validation";
                var scene = EditorSceneManager.NewScene(NewSceneSetup.EmptyScene, NewSceneMode.Single);
                new GameObject("FLAC assertions").AddComponent<FlacBehaviour>();
                EditorSceneManager.SaveScene(scene, "Assets/Flac.unity");
