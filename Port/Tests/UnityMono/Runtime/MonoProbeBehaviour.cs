...
namespace SCUnity.Validation
{
    ...
    public sealed class MonoProbeBehaviour : MonoBehaviour
    {
        [Serializable] public sealed class Check { public string name; public bool passed; }
        [Serializable] public sealed class Result
        {
            public string schema = "scunity-mono-probe-v1";
        ...
        void Start()
        {
            ...
            try
            {
                ...
                foreach (var check in Probe.Entry.Run(payload))
            ...
            Debug.Log("SCUnity Mono probe: " + (result.passed ? "PASS" : "FAIL") + " " + result.error);
