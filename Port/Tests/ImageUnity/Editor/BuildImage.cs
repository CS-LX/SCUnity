...
{
    public static class BuildImage
    {
        ...
        public static void Build()
        {
            try
            {
                ...
                PlayerSettings.productName = "SCUnity Image Validation";
                var scene = EditorSceneManager.NewScene(NewSceneSetup.EmptyScene, NewSceneMode.Single);
                new GameObject("Image assertions").AddComponent<ImageBehaviour>();
                EditorSceneManager.SaveScene(scene, "Assets/Image.unity");
