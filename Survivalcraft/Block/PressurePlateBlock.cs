...
namespace Game {
    public class PressurePlateBlock : MountedElectricElementBlock {
        ...
        public int[] m_creativeValuesByMaterial = new int[] { Terrain.MakeBlockValue(144, 0, 0), Terrain.MakeBlockValue(144, 0, 1) };

        public int[] m_textureSlotsByMaterial = new int[] { 4, 1 };
        ...
        public override void Initialize() {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                for (int j = 0; j < 6; j++) {
                    ...
                    m_collisionBoxesByData[num2] = new global::Engine.BoundingBox[] {                         new BoundingBox(
