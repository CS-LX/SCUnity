...
namespace Game {
    public class TerrainContentsGenerator24 : ITerrainContentsGenerator {
        ...
        public class Grid2d {
            ...
            public virtual float Get(int x, int y) => m_data[x + y * m_sizeX];
        ...
        public class Grid3d {
            ...
            public virtual void Get8(int x,
                int y,
                int z,
                out float v111,
                out float v211,
            ...
            public virtual float Get(int x, int y, int z) => m_data[x + y * m_sizeX + z * m_sizeXY];
        ...
        public virtual float CalculateMountainRangeFactor(float x, float z) => SimplexNoise.OctavedNoise(
        ...
        public virtual int CalculateHumidity(float x, float z) => Math.Clamp(
            (int)(MathUtils.Saturate(
        ...
        public virtual float CalculateOceanShoreX(float z) => m_oceanCorner.X
            + TGShoreFluctuations * SimplexNoise.OctavedNoise(z, 0f, 0.005f / TGShoreFluctuationsScaling, 4, 1.95f, 1f);

        public virtual float CalculateOceanShoreZ(float x) => m_oceanCorner.Y
        ...
        public virtual void GenerateCaves(TerrainChunk chunk) {
            ...
            List<CavePoint> list = new global::System.Collections.Generic.List<global::Game.TerrainContentsGenerator24.CavePoint>() {  };
            int x = chunk.Coords.X;
            int y = chunk.Coords.Y;
