            ...
            for (int i = x2; i <= x2; i++) {
                for (int j = y2; j <= y2; j++) {
                    ...
                    for (int n = 0; n < 32; n++) {
                        ...
                        if (!BlocksManager.Blocks[Terrain.ExtractContents(value8)].IsCollidable_(value8)
                            && !BlocksManager.Blocks[Terrain.ExtractContents(value9)].IsCollidable_(value9)
                            && !BlocksManager.Blocks[Terrain.ExtractContents(value10)].IsCollidable_(value10)
                            && !BlocksManager.Blocks[Terrain.ExtractContents(value11)].IsCollidable_(value11)) {
