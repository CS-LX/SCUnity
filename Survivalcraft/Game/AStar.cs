    ...
    public class AStar<T> {
        ...
        public void HeapifyFromPosToEnd(int pos) {
            while (true) {
                ...
                int num2 = 2 * pos + 1;
                int num3 = 2 * pos + 2;
                if (num2 < m_openHeap.Count
                    && m_openHeap.Array[num2].F < m_openHeap.Array[num].F) {
                    num = num2;
                }
                if (num3 < m_openHeap.Count
                    && m_openHeap.Array[num3].F < m_openHeap.Array[num].F) {
                    num = num3;
                }
                if (num != pos) {
