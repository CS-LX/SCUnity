...
namespace Game {
    public class SubsystemElectricBlockBehavior : SubsystemBlockBehavior {
        ...
        public override int[] HandledBlocks => new int[] {             133,             140,             137,             143,             156,             134,             135,             145,             224,             146,             157,             180,             181,             183,             138,             139,             141,             142,             184,             187,             186,             188,             144,             151,             179,             152,             254,             253,             182,             185,             56,             57,             58,             83,             84,             166,             194,             86,             63,             97,             98,             210,             211,             105,             106,             107,             234,             235,             236,             147,             153,             154,             223,             155,             243,             120,             121,             199,             216,             227,             237
 };
        ...
        public override void OnNeighborBlockChanged(int x, int y, int z, int neighborX, int neighborY, int neighborZ) {
            for (int i = 0; i < 6; i++) {
                m_subsystemElectricity.GetElectricElement(x, y, z, i)
