...
Shader "SCUnity/Port/60c3c8a5d5a6d0cf" {
...
#pragma multi_compile _ ALPHATESTED
#pragma multi_compile _ USE_SKINNING
...
#ifdef USE_SKINNING
	in float4 a_joints: TEXCOORD6,
	in float4 a_weights: TEXCOORD5,
#endif
